...
from plotting_ringer import (RMSD_histogram,plot_fit)
...
def three_normal_fix(x,sigma_1,sigma_2,sigma_3,offset):
    ...
    return three_gaussian_fix(x,amplitude,sigma_1,amplitude,sigma_2,amplitude,
                              sigma_3,offset)

############################################################################### 
# Non Linear Least square fitting routine for fitting plot to given function 
# ( Three Gaussians)
###############################################################################
